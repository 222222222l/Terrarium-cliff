# Package Skill Policy For Creature Creation

This folder is the package-local selection shelf for optional skills that may
be attached when creating a creature.

Important constraint:

- callable skills for this package now live under `examples/test-kit/skills/`
- this folder exists as a stable selection index and policy layer, not as an alternate runtime discovery root
...
This folder keeps selection material separate while preserving the supported
...
1. keep the callable skill in this package's `skills/` directory
...
When adding future package-level creature-creation skills:

1. add the actual callable skill under `examples/test-kit/skills/`
